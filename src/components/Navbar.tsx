...
import { NotificationHeadlineBar } from './NotificationHeadlineBar';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-col">
      {/* Top Notification Headline Bar */}
      <NotificationHeadlineBar
        onCheckResultClick={onCheckResultClick}
        onStudentPortalClick={onStudentPortalClick}
      />
