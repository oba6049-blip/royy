        ...
        <div className="glass-panel-dark rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-slate-800">
          {!isAuthenticated ? (
            ...
            <div className="max-w-xl mx-auto py-8 px-4 text-center space-y-6">
              ...
              <form onSubmit={handleInlineLogin} className="bg-slate-950 p-6 rounded-2xl border border-slate-800 text-left space-y-4 shadow-xl">
                <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl pl-10 pr-10 py-2.5 text-xs font-mono font-bold text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <button
                      type="button"
